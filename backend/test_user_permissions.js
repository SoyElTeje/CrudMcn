...
async function testUserPermissions() {
  ...
  try {
    ...
    // 3. Obtener el ID del usuario de prueba
    console.log("\n3️⃣ Obteniendo ID del usuario de prueba...");
    ...
    console.log(`✅ Usuario de prueba encontrado con ID: ${testUser.id}`);

    // 4. Asignar permisos limitados al usuario
    console.log("\n4️⃣ Asignando permisos limitados...");

    // Asignar permisos de base de datos completa a BD_ABM1
    await axios.post(
      `${BASE_URL}/api/auth/users/${testUser.id}/database-permissions`,
      {
    ...
    // 5. Probar acceso a bases de datos como admin
    console.log("\n5️⃣ Probando acceso como admin...");
    ...
    // 6. Probar acceso a bases de datos como usuario normal
    console.log("\n6️⃣ Probando acceso como usuario normal...");
    ...
    // 7. Probar acceso a tablas específicas
    console.log("\n7️⃣ Probando acceso a tablas...");
