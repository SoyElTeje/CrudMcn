...
async function testVeryNewDates() {
  try {
    console.log("=== Prueba con Cédulas Muy Nuevas ===\n");
    ...
    const insertData1 = {
      ...
      Cedula: "99999991", // Cédula muy nueva
    ...
    const insertData2 = {
      ...
      Cedula: "99999992", // Cédula muy nueva
    ...
    const insertData3 = {
      ...
      Cedula: "99999993", // Cédula muy nueva
